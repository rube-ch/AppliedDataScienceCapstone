...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        filtered_df = filtered_df[filtered_df['class'] == 1].groupby('Launch Site').count().reset_index()
        ...
        filtered_df = filtered_df[filtered_df['Launch Site'] == entered_site].groupby('class').count().reset_index()
